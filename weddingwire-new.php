...
$categories = array();
    ...
    for($l = 0; $l < count($locations); $l++){
        switch ($cid){
            case 'wedding-venues':
                $url = 'https://www.weddingwire.com/c/'.$locations[$l].'/wedding-venues/11-sca.html';
                break;
            case 'wedding-bands':
                $url = 'https://www.weddingwire.com/c/'.$locations[$l].'/wedding-bands/1-sca.html';
                break;
            case 'wedding-beauty-health':
                $url = 'https://www.weddingwire.com/c/'.$locations[$l].'/wedding-beauty-health/16-sca.html';
                break;
            case 'wedding-caterers':
                $url = 'https://www.weddingwire.com/c/'.$locations[$l].'/wedding-caterers/3-sca.html';
                break;
            case 'wedding-ceremony-music':
                $url = 'https://www.weddingwire.com/c/'.$locations[$l].'/wedding-ceremony-music/4-sca.html';
                break;
            case 'wedding-djs':
                $url = 'https://www.weddingwire.com/c/'.$locations[$l].'/wedding-djs/7-sca.html';
                break;
            case 'wedding-dresses':
                $url = 'https://www.weddingwire.com/c/'.$locations[$l].'/wedding-dresses/17-sca.html';
                break;
            case 'wedding-event-rentals':
                $url = 'https://www.weddingwire.com/c/'.$locations[$l].'/wedding-event-rentals/12-sca.html';
                break;
            case 'photo-booths':
                $url = 'https://www.weddingwire.com/c/'.$locations[$l].'/photo-booths/207-sca.html';
                break;
            case 'wedding-favors':
                $url = 'https://www.weddingwire.com/c/'.$locations[$l].'/wedding-favors/5-sca.html';
                break;
            case 'wedding-florists':
                $url = 'https://www.weddingwire.com/c/'.$locations[$l].'/wedding-florists/8-sca.html';
                break;
            case 'lighting-decor':
                $url = 'https://www.weddingwire.com/c/'.$locations[$l].'/lighting-decor/24-sca.html';
                break;
            case 'wedding-photographers':
                $url = 'https://www.weddingwire.com/c/'.$locations[$l].'/wedding-photographers/10-sca.html';
                break;
            case 'wedding-videographers':
                $url = 'https://www.weddingwire.com/c/'.$locations[$l].'/wedding-videographers/14-sca.html';
                break;
            case 'wedding-cakes':
                $url = 'https://www.weddingwire.com/c/'.$locations[$l].'/wedding-cakes/2-sca.html';
                break;
            case 'wedding-planners':
                $url = 'https://www.weddingwire.com/c/'.$locations[$l].'/wedding-planners/15-sca.html';
                break;
        }
